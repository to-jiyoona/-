...
const reviews = [
  { gender: "여", age: 27, job: "회계·세무 직장인", review: <>크리스천으로서 <strong className="font-semibold text-[#8A5A53]">연애와 결혼에 대해 깊게 고민</strong>해본 시간이었습니다. 2주차도 기대됩니다</> },
  { gender: "남", age: 31, job: "교사", review: <>강의 내용이 <strong className="font-semibold text-[#8A5A53]">생각보다 알차고 깊었습니다.</strong> 기독교적 가치관 안에서 올바른 연애와 결혼관을 들을 수 있어 좋았습니다</> },
  { gender: "여", age: 34, job: "간호사", review: <><strong className="font-semibold text-[#8A5A53]">같은 고민을 갖고 있는 크리스천 청년들이 많다</strong>는 것에 위로가 되었고 희망과 용기를 얻었습니다</> },
  { gender: "남", age: 36, job: "경찰관", review: <>비슷한 고민을 가진 청년들이 모여 <strong className="font-semibold text-[#8A5A53]">신앙 안에서 얘기를 나눌 수 있는 시간</strong>이어서 좋았습니다</> },
  { gender: "여", age: 30, job: "교사", review: <>친구에게 어서 <strong className="font-semibold text-[#8A5A53]">2기를 추천</strong>할 예정이에요!</> },
  { gender: "남", age: 36, job: "서비스직", review: <>걱정도 많았지만 <strong className="font-semibold text-[#8A5A53]">강의도 너무 좋았고 프로그램이 알차고 유익</strong>했습니다. 다음 회차가 기다려집니다!</> },
  { gender: "여", age: 32, job: "IT 기획·PM", review: <>생각보다 <strong className="font-semibold text-[#8A5A53]">부담스럽지도, 두렵지도 않았습니다.</strong> 2주차가 너무 기대됩니다!</> },
  { gender: "남", age: 34, job: "안전관리자", review: <>연애와 결혼을 고민하는 <strong className="font-semibold text-[#8A5A53]">크리스천에게 꼭 필요한 말씀</strong>이었습니다. 여러 사람과의 나눔이 너무나도 감사한 시간이었습니다</> },
  { gender: "여", age: 31, job: "커머스 직장인", review: <><strong className="font-semibold text-[#8A5A53]">명확한 목표와 신앙을 가진 분들</strong>과 나눔이 은혜가 됐습니다. 다음 모임도 기대됩니다!</> },
  { gender: "남", age: 28, job: "의사", review: <>걱정과 달리, <strong className="font-semibold text-[#8A5A53]">목소리만으로 나누는 게 오히려 진솔</strong>했어요. 다음 회차가 기대됩니다</> },
  { gender: "여", age: 34, job: "간호사", review: <><strong className="font-semibold text-[#8A5A53]">건강한 방향으로 가고자 하는 청년들이 많구나,</strong> 같은 고민을 하는 청년들이 많구나 느꼈어요</> },
  { gender: "남", age: 31, job: "공기업 직원", review: <>처음엔 긴장했지만 <strong className="font-semibold text-[#8A5A53]">분위기가 편안</strong>했고 앞으로의 시간도 기대됩니다</> },
];
...
export function LandingPage() {
  ...
  return (
    <div className="font-sans text-[#2D2A26] bg-white w-full overflow-x-hidden">
      ...
      {/* 1. Hero Section */}
      <header className="relative w-full h-[70vh] md:h-screen flex flex-col items-center justify-start pt-[12vh] md:pt-[18vh] text-center overflow-hidden bg-[#FAF7F5]">
        <div
          className="absolute inset-0 bg-cover bg-[center_15%] md:bg-[center_30%]"
          style={{ backgroundImage: `url(${heroBgImg})` }}
        />
        <div className="absolute inset-0 bg-gradient-to-b from-black/10 to-[#2D2A26]/55" />
        ...
        >
          ...
          >
            <p className="text-lg sm:text-xl md:text-2xl font-semibold text-[#FAD4CE] drop-shadow-md">
              초원 메이트
            </p>
            <span className="text-xs sm:text-sm font-semibold text-[#8A5A53] bg-[#FAD4CE] px-2.5 py-1 rounded-full drop-shadow-md">
              6월
            </span>
          </motion.div>
        </motion.div>
        ...
        >
          <div className="flex flex-col items-center gap-3">
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center justify-center px-8 py-4 md:px-12 md:py-5 text-base md:text-lg font-bold text-white bg-[#D68C82] hover:bg-[#C27A71] rounded-full transition-colors shadow-xl shadow-[#D68C82]/30"
            >
              지금 신청하기 →
            </motion.a>
      ...
      <section className="py-20 md:py-32 px-6 bg-[#FAF7F5]">
        <div className="max-w-4xl mx-auto flex flex-col items-center gap-12 lg:gap-16">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl md:text-[40px] font-bold text-gray-900 mb-6 md:mb-8 leading-[1.3] tracking-tight text-center">
              ...
              <span className="relative inline-block z-10">
                막막할까요?
                <svg className="absolute w-[105%] h-[0.3em] -bottom-[0.05em] -left-[2%] text-[#D68C82] -z-10" viewBox="0 0 100 20" preserveAspectRatio="none">
                ...
                {[
                  ...
                  >
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs font-semibold text-[#D68C82]">{item.age} · {item.job}</span>
                    </div>
                    <div className="max-w-[85%] px-5 py-3 bg-white rounded-[1.5rem] rounded-tl-[4px] border border-[#F2EBE9] text-[#2D2A26] shadow-sm">
              ...
              <div className="flex flex-col gap-5">
                {[
                  ...
                  >
                    ...
                    <div className="max-w-[85%] px-5 py-3 bg-[#D68C82] rounded-[1.5rem] rounded-tr-[4px] text-white shadow-sm shadow-[#D68C82]/20">
                      <p className="text-[15px] font-medium leading-[1.6]">{item.text}</p>
                    </div>
                  </motion.div>
                ))}
            ...
            <motion.p
              ...
              className="text-center text-[#D68C82] font-semibold text-base md:text-lg mt-14 mb-4"
            >
          ...
          >
            ...
            <p className="text-sm md:text-base text-[#6B6661] font-light">지금 화면 우측 <strong>채널톡 아이콘</strong>을 누르고 문의사항을 남겨주세요.</p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="w-full md:w-1/3 flex-shrink-0 flex flex-col items-center md:items-start">
              ...
              <div className="md:hidden mt-6 text-center">
                <p className="text-base font-bold text-[#D68C82] tracking-wide">초원메이트 기획자 이지윤</p>
              </div>
            </div>

            <div className="w-full md:w-1/2 flex flex-col text-center md:text-left">
              <div className="hidden md:block mb-6">
                <p className="text-lg font-bold text-[#D68C82] tracking-wide">초원메이트 기획자 이지윤</p>
              </div>
              ...
              <p className="text-base sm:text-lg md:text-xl leading-[1.9] md:leading-[1.95] text-[#2D2A26] font-light mt-4">
                "<strong className="font-semibold text-[#D68C82]">초원메이트는 한 번의 휘발성 이벤트가 아니라, 신앙 안에서 좋은 만남이 이루어지는 과정을 제공하는 프로그램입니다.</strong>"
              </p>
            </div>
          </motion.div>
        </div>
      ...
      {/* Season 1 Review */}
      <section className="py-16 md:py-24 px-6 bg-[#D68C82]">
        <div className="max-w-5xl mx-auto">
          ...
          >
            <span className="text-[#FAD4CE] font-semibold tracking-widest text-xs md:text-sm mb-3 block uppercase">
              Season 1 Review
            </span>
              ...
              {Array.from({ length: totalReviewPages }).map((_, pageIdx) => (
                <div key={pageIdx} className="min-w-full snap-start flex flex-col gap-4">
                  {reviews.slice(pageIdx * 2, pageIdx * 2 + 2).map((item, i) => (
                    <div
                      key={i}
                      className="bg-[#FAF7F5] rounded-2xl p-6 md:p-7 flex flex-col gap-3 flex-1"
                    >
                      <span className="text-[#D68C82] text-2xl font-serif leading-none">"</span>
                      <p className="text-[#2D2A26] text-sm md:text-base leading-relaxed font-light flex-1">
                        {item.review}
                      </p>
                      <div className="flex items-center gap-2 pt-3 border-t border-[#F2EBE9]">
                        <span className={`text-xs font-bold px-2 py-0.5 rounded-full ${
                          item.gender === "여"
                            ? "bg-[#D68C82]/15 text-[#8A5A53]"
                            : "bg-[#D68C82]/10 text-[#D68C82]"
                        }`}>
                          {item.gender}
                        </span>
      ...
      <section className="py-16 md:py-28 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          <motion.div
            ...
            className="text-center mb-12 md:mb-20"
          >
            <span className="text-[#D68C82] font-semibold tracking-widest text-xs md:text-sm mb-2 md:mb-3 block uppercase">Curriculum</span>
              ...
              >
                {session.img && index === 1 && (
                  <div className="absolute inset-0 z-0 opacity-30">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-br from-[#FAF7F5]/80 via-[#FAF7F5]/50 to-[#FAF7F5]/30" />
                  </div>
                )}
                {session.img && index !== 1 && (
                ...
                <div className="relative z-10 flex flex-col justify-between h-full min-h-[260px] md:min-h-[280px] p-6 md:p-8 lg:p-10">
                  ...
                  <div className="text-left mt-auto w-full md:w-[85%]">
                    ...
                    <div className="mt-4 pt-4 border-t border-[#D68C82]/20 flex items-center gap-1.5 md:gap-2 text-[#8A5A53] font-medium text-xs md:text-sm">
                      ...
                      <span className="ml-2 px-2 py-0.5 bg-[#D68C82]/10 text-[#D68C82] rounded-full text-xs font-semibold uppercase tracking-wide">{session.mode}</span>
                    </div>
          ...
          <motion.div
            ...
            className="w-full mt-16 md:mt-24 pt-12 md:pt-16 border-t border-[#F2EBE9]"
          >
        ...
        <div className="max-w-4xl mx-auto mt-10 md:mt-14 px-2">
          ...
          >
            ...
            <div className="space-y-4 text-sm md:text-base text-[#6B6661] font-light leading-relaxed">
              ...
              <p>한 분의 빈자리가 다른 참가자분들의 경험에 직접 영향을 주기 때문에, <strong>결제시점으로부터 48시간</strong> 이내에만 환불이 가능해요. 이후에는 사정이 생기더라도 환불이 어려우니, 일정을 충분히 확인하신 후 신청해 주세요.</p>
          ...
          {[
            ...
            },
            {
              ...
              items: [
                ...
                { q: "카드 할부는 몇 개월까지 가능한가요?", a: "카드 최대 5개월 무이자 할부 가능합니다.\n(단, 일부 카드사의 경우 무이자 개월 수 및 적용 조건이 상이할 수 있으며, 자세한 사항은 각 카드사 규정을 따릅니다.)" },
